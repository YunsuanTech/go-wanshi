...
var (
	...
	TestnetGenesisHash  = common.HexToHash("0xbf7e331f7f7c1dd2e05159666b3bf8bc7a8a3a9eb1d518969eab529dd9b88c1a")
)
...
var (
	...
	// TestnetChainConfig contains the chain parameters to run a node on the Görli test network.
	...
	AllCliqueProtocolChanges = &ChainConfig{big.NewInt(MainnetChainID), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, &CliqueConfig{Period: 0, Epoch: 30000}}
